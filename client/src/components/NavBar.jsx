...
export default function NavBar() {
  ...
  return (
    ...
    >
      ...
      <div
        className={`w-full md:w-1/2 flex flex-col md:flex-row justify-center items-center gap-5 uppercase text-sm md:text-md overflow-hidden transition-all md:transition-none duration-1000 order-3 md:order-2 md:h-16 md:p-0 ${
          open ? "h-56 p-5" : "h-0"
        }`}
      >
        <div
          ...
          className="h-12 md:w-1/3 flex justify-center items-center px-5 py-2 hover:border-b-2 border-black cursor-pointer"
        >
          home
        </div>
        <div
